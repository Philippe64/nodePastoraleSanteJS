...
function handleRequest(response, request, pathAppli, pathName) {
	...
	if (pathName === '' || pathName === '\/') {
		...
		if (strRacineWeb.indexOf("/") > 0) {
			strRacineWeb = strRacineWeb.substring(0, strRacineWeb.indexOf("/"))
		}
		// --------------------------------
...
// demande de Favicon
function ico(response, request, pathAppli, icoPath) {
