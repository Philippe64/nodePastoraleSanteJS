var tooltipOptions = {
	...
	sticky : false,
	overlay : false,
	//license: "245t9"  // for cia-it domain
	license : "64628"  // licence developper
};
...
var tooltip = function (B) {
	...
	if (Kb)
		var Xb = W.msPointerEnabled ? "onmspointerout" : "onpointerOut";
	var Qb = function (a) {
	...
	eb = function (a, b) {
		if (a) {
			a.op = b;
			if (tb)
				a[d].filter = "alpha(opacity=" + b * 100 + ")";
			else
				a[d][I] = b
		}
	},
	...
	var Bb = function () {
		...
		if (l && l.m && c[P].indexOf(ib("kdvh#Uh")) != -1)
			g.i = Nb;
		return g
	},
	vb = function (d, c, b) {
